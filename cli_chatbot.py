...
def main(
    ...
    peft_model: str=TRAIN_CONFIG.output_dir,
    quantization: bool=TRAIN_CONFIG.quantization,
    max_new_tokens =300, #The maximum numbers of tokens to generate
    seed: int=TRAIN_CONFIG.seed, #seed value for reproducibility
    ...
    **kwargs
    ...
    start_prompt_english = [
        {"role": "user", "content": "Your name is Me-bot. An AI chatbot trained on the iMessage chats of a human."},
